                ...
                <aside class="sidebar-area">
                    <div class="widget widget_categories">
                        ...
                        <div class="nav nav-tabs menu-tabs" id="nav-tab" role="tablist" style="display: block;">
                            ...
                            <button class="nav-link category-btn text-capitalize"
                                data-category="<?php echo $category['id']; ?>" type="button">
                    ...
                    <div class="col-xl-4 col-lg-4 col-sm-6 product-item"
                        ...
                        <div class="th-product" style="padding: 10px">
                            ...
                            <div class="product-content">
                                ...
                                <?php if (!empty($product['price1'])): ?>
                                <span class="price text-capitalize">₹ <?php echo $product['price1']; ?></span> Onwards
                                <?php endif; ?><br>
                                <?php if (!empty($product['price2'])): ?>
                                <span class="price text-capitalize">₹ <?php echo $product['price2']; ?></span> Onwards
                                <?php endif; ?>
                                <div class="actions">
